...
export class WorldMap {
    ...
    private mapHeight: number = 400;
    private mapX: number;
    private mapY: number;
    private playerWorldPos: Position = { x: 0, y: 0 };
    ...
    public update(deltaTime: number, playerPos: Position, worldWidth: number, worldHeight: number): void {
    ...
    private renderFallbackMap(ctx: CanvasRenderingContext2D): void {
