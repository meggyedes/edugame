...
export class ForestBiome extends BaseBiome {
    ...
    private drawPixelMountainWithTrees(x: number, y: number, width: number, height: number, color1: string, color2: string, pixelSize: number): void {
    ...
    private drawMiniPineTree(x: number, y: number, height: number, color: string, pixelSize: number): void {
        const layers = 3;
    ...
    private drawPixelPineTree(x: number, y: number, height: number, darkColor: string, lightColor: string, pixelSize: number): void {
        // Trunk
    ...
    private drawPixelDeciduousTree(x: number, y: number, height: number, darkColor: string, lightColor: string, pixelSize: number): void {
        // Trunk
    ...
    private drawGrassLayers(groundY: number): void {
    ...
    private drawGrassBlades(groundY: number): void {
    ...
    private drawPixelRock(x: number, y: number, size: number): void {
    ...
    private drawPixelBush(x: number, y: number, size: number, color: string): void {
        const random = this.seededRandom(x * 100);
    ...
    private drawPixelFlower(x: number, y: number, color: string): void {
        // Stem
