...
export { BaseBiome, type BiomeConfig } from './BaseBiome.js';
...
export class BiomeManager {
    private biomes: Map<string, BaseBiome> = new Map();
     ...
     * Get a biome by name
     */
    public getBiome(name: string): BaseBiome | undefined {
     ...
     */
    public getBiomeByContinent(continentId: ContinentId): BaseBiome | undefined {
     ...
     */
    public setCurrentBiome(name: string): boolean {
     ...
     */
    public setCurrentBiomeByContinent(continentId: ContinentId): boolean {
     ...
     */
    public getCurrentBiome(): BaseBiome | null {
     ...
     */
    public getContinents(): ContinentInfo[] {
        return CONTINENTS;
    }
     ...
     */
    public getContinentInfo(continentId: ContinentId): ContinentInfo | undefined {
     ...
     */
    public getCurrentBiomeDimensions(): { width: number; height: number } | null {
        if (this.currentBiome) {
            return {
