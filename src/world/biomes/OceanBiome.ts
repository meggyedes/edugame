...
export class OceanBiome extends BaseBiome {
    ...
    private drawUnderwaterMountain(x: number, y: number, width: number, height: number, color: string): void {
    ...
    private drawSeaweed(x: number, y: number, height: number, color: string, pixelSize: number): void {
    ...
    private drawCoral(x: number, y: number, size: number, type: number, opacity: number): void {
    ...
    private drawBrainCoral(x: number, y: number, size: number, color: string, accent: string): void {
    ...
    private drawBranchingCoral(x: number, y: number, size: number, color: string, accent: string): void {
    ...
    private drawFanCoral(x: number, y: number, size: number, color: string, accent: string): void {
        // Fan-shaped coral
    ...
    private drawTubeCoral(x: number, y: number, size: number, color: string, accent: string): void {
    ...
    private drawAnemone(x: number, y: number, size: number): void {
    ...
    private drawOceanFloor(groundY: number): void {
        const layers = [
    ...
    private drawUnderwaterRock(x: number, y: number, size: number): void {
    ...
    private drawStarfish(x: number, y: number): void {
    ...
    private drawShell(x: number, y: number): void {
    ...
    private drawSmallCoral(x: number, y: number): void {
    ...
    private drawForegroundBubbles(groundY: number): void {
