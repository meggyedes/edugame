...
export class DesertBiome extends BaseBiome {
    ...
    private drawDesertSun(x: number, y: number): void {
        // Heat shimmer effect
    ...
    private drawDistantRockFormation(x: number, y: number, width: number, height: number): void {
    ...
    private drawSandDune(x: number, y: number, width: number, height: number, color: string): void {
    ...
    private drawDesertTree(x: number, y: number, height: number): void {
    ...
    private drawDesertRock(x: number, y: number, size: number, baseColor: string): void {
    ...
    private drawDesertGround(groundY: number): void {
    ...
    private drawSpinifex(x: number, y: number, size: number): void {
    ...
    private drawDesertPlant(x: number, y: number): void {
    ...
    private drawSmallRock(x: number, y: number): void {
    ...
    private drawGroundCracks(x: number, y: number): void {
        const random = this.seededRandom(x * y);
    ...
    private drawBones(x: number, y: number): void {
        // Simple bone shapes
