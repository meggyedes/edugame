...
export class SavannahBiome extends BaseBiome {
    ...
    private drawDistantHill(x: number, y: number, width: number, height: number, color: string): void {
    ...
    private drawAcaciaTree(x: number, y: number, height: number, trunkColor: string, leafColor: string, pixelSize: number, isSilhouette: boolean): void {
        // Trunk (thin and tall)
    ...
    private drawTallGrass(x: number, y: number, height: number, color: string): void {
    ...
    private drawSavannahGround(groundY: number): void {
        // Dry earth layers
        const layers = [
    ...
    private drawTermiteMound(x: number, y: number, height: number): void {
    ...
    private drawGoldenGrass(groundY: number): void {
    ...
    private drawSavannahRock(x: number, y: number, size: number): void {
    ...
    private drawDryShrub(x: number, y: number, size: number): void {
