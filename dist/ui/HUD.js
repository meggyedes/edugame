...
export class HUD {
    ...
    renderBiomeIndicator(ctx, canvasWidth) {
        const biomeData = {
    ...
    renderInteractionPrompt(ctx, canvasWidth, canvasHeight) {
    ...
    setMinimapData(playerX, playerY, worldWidth, worldHeight, exploredChunks) {
        this.minimapData = { playerX, playerY, worldWidth, worldHeight, exploredChunks };
    }
    setBadgeCount(unlocked, total) {
