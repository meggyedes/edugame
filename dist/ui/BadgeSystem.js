...
export class BadgeSystem {
    ...
    updateProgress(type, value, specificBadgeId) {
    ...
    updateZoneBadge(zoneId, completedLevels) {
        const zoneToId = {
    ...
    render(ctx, width, height) {
        if (!this.showNotification || !this.notificationBadge)
            return;
    ...
    renderBadgePanel(ctx, width, height) {
        const lang = this.i18n.getLanguage();
...
//# sourceMappingURL=BadgeSystem.js.map