...
export class SpriteLoader {
    ...
    addSpriteAlias(aliasId, targetId) {
    ...
    drawSprite(ctx, spriteId, destX, destY, scale = 1, flipX = false) {
        ...
        if (flipX) {
            ...
            ctx.scale(-1, 1);
            ctx.drawImage(this.spriteSheet, sprite.x, sprite.y, sprite.width, sprite.height, 0, 0, destWidth, destHeight);
        }
        else {
            ctx.drawImage(this.spriteSheet, sprite.x, sprite.y, sprite.width, sprite.height, destX, destY, destWidth, destHeight);
        }
        ctx.restore();
        return true;
    }
