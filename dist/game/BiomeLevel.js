...
import { Evidence, EVIDENCE_DATABASE } from '../entities/Evidence.js';
// Biome level definitions
export const BIOME_LEVELS = [
    {
        id: 'beach',
        biome: 'beach',
...
export class BiomeLevel {
    ...
    onEvidencePhotographed(evidence) {
    ...
    isLevelComplete() {
        for (const progress of this.animalProgress.values()) {
            if (!progress.animalPhotographed)
                return false;
        }
        return true;
    }
    ...
    // Getters
    getLevelData() { return this.levelData; }
    getAnimals() { return this.animals; }
    getEvidence() { return this.evidence; }
    getDecorations() { return this.decorations; }
    getAnimalProgress(animalId) { return this.animalProgress.get(animalId); }
    getAllProgress() { return this.animalProgress; }
    getWidth() { return this.levelData.width; }
    getHeight() { return this.levelData.height; }
    getBiomeType() { return this.levelData.biome; }
...
//# sourceMappingURL=BiomeLevel.js.map