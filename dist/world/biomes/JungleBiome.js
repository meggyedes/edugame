...
export class JungleBiome extends BaseBiome {
    ...
    drawMistyMountain(x, y, width, height, color, opacity) {
    ...
    drawJungleTree(x, y, height, darkColor, lightColor, pixelSize, hasCanopy) {
...
//# sourceMappingURL=JungleBiome.js.map