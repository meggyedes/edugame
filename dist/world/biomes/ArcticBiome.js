...
export class ArcticBiome extends BaseBiome {
    ...
    drawIceMountain(x, y, width, height, lightColor, shadowColor) {
    ...
    drawSnowDrift(x, y, width, height) {
...
//# sourceMappingURL=ArcticBiome.js.map